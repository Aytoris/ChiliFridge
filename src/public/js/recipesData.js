...
const RECIPES_DATA = {
  ...
  "Bean Burger": {
    ...
    instructions: [
      ...
      "Dough: oil, WARM water, salt, yeast. REST 5min, then flour & BEATEN egg",
      ...
      "https://thefeatherednester.com/quick-and-easy-hamburger-buns/",
    ],
    servings: 1,
    protein: "beans",
    cookingTime: 25,
